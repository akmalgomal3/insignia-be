...
from app.schemas.task import TaskCreate, TaskUpdate, Task as TaskSchema, TaskListResponse
...
@router.get("/{task_id}", response_model=TaskSchema, dependencies=[Depends(verify_token)])
...
@router.put("/{task_id}", response_model=TaskSchema, dependencies=[Depends(verify_token)])
